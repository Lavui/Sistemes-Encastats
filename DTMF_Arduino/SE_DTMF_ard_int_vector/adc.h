...
//DIDR0 combinations
//to enable 2 inputs DIDR0=adc5d&adc4d
#define adc5d 0b00011111
#define adc4d 0b00101111
#define adc3d 0b00110111
#define adc2d 0b00111011
#define adc1d 0b00111101
#define adc0d 0b00111110
#define adcxd 0b00111111
